...
This section is for developers who are evaluating Loom-team more deeply, configuring it beyond the
...
<div className="routa-doc-map">
  <a href="/Loom-team/configuration">
    ...
    Set up providers, models, and environment variables so Loom-team can actually run useful work.
  </a>
  <a href="/Loom-team/administration">
    <strong>Administration</strong>
    Use self-hosting, deployment, and release-oriented docs when you are operating Loom-team for a
    team or internal environment.
  </a>
  <a href="/Loom-team/developer-guide/project-structure">
    <strong>Project Structure</strong>
    Learn how the Web-only runtime pieces fit together.
  </a>
  <a href="/Loom-team/ARCHITECTURE">
    <strong>Architecture</strong>
    Read the canonical system boundaries, runtime topology, and single-backend invariants.
  </a>
  <a href="/Loom-team/developer-guide/testing">
    <strong>Testing</strong>
    Understand the validation flow and fitness tiers when changing or running Loom-team yourself.
  </a>
  <a href="/Loom-team/developer-guide/local-overlay-sync">
    <strong>Local Overlay Sync</strong>
    Keep a self-hosted Loom-team checkout upgradeable when you also carry local-only patches and
...
- running Loom-team in a team or self-hosted environment
- extending Loom-team after the user-facing path is already clear

## Recommended Reading Order

1. Read [Configuration](/configuration) to get one provider and one working model path.
2. Read [Administration](/administration) if you are operating Loom-team for a team or internal environment.
...
5. Read [Local Overlay And Upstream Sync](/developer-guide/local-overlay-sync) if you run Loom-team locally with long-lived local patches and still need clean upstream updates.
...
- [Contributing](/developer-guide/contributing): contribution flow for Loom-team itself
