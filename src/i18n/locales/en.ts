...
const en: TranslationDictionary = {
  ...
  repoPicker: {
    ...
    nonGitFolderNotice: "This is a plain local folder. Version control is not enabled.",
    versionControlDisabled: "No version control",
    errorFolderNotFound: "The folder does not exist. Check the path and try again.",
    errorNotADirectory: "The path is a file, not a directory. Choose a folder instead.",
    errorFolderNotReadable: "The folder is not readable. Check its read permissions and try again.",
    errorBareRepository: "Bare git repositories cannot be used as a codebase. Use a working copy instead.",
    errorLoadLocalFolderFailed: "Failed to load the local folder.",
  ...
  workspace: {
    ...
    saving: "Saving…",
    defineGoal: "Define product goal",
  },

  goal: {
    title: "Product Goal",
    description: "Define what you want to build. This structured intent guides planning and execution.",
    goalText: "Goal Description",
    goalTextPlaceholder: "Describe the product or feature you want to build...",
    repos: "Repositories",
    reposDescription: "Codebases involved in this goal.",
    addRepo: "Add Repository",
    requirementDocs: "Requirement Documents",
    requirementDocsDescription: "Attach specifications, PRDs, or design docs.",
    addDoc: "Add Document",
    docName: "Document Name",
    docContent: "Content",
    docNamePlaceholder: "e.g., API Spec",
    docContentPlaceholder: "Paste or write the document content...",
    constraints: "Technical Constraints",
    constraintsDescription: "Hard limits, tech stack requirements, or non-negotiable decisions.",
    addConstraint: "Add Constraint",
    constraintPlaceholder: "e.g., Must use PostgreSQL",
    save: "Save Goal",
    startPlanning: "Start Planning",
    saveSuccess: "Goal saved successfully.",
    saveError: "Failed to save goal.",
    loadError: "Failed to load goal.",
    draft: "Draft",
    active: "Active",
    repoKindLocal: "Local",
    repoKindGithub: "GitHub",
    repoPath: "Path",
    repoUrl: "URL",
  },
