    ...
    return NextResponse.json(
      {
        ...
        counts: {
          ...
          explicitKanbanCards: plan.explicitKanbanTaskIds.length,
          legacyKanbanCards: plan.legacyKanbanTaskIds.length,
        ...
        explicitKanbanTaskIds: plan.explicitKanbanTaskIds,
        legacyKanbanTaskIds: plan.legacyKanbanTaskIds,
